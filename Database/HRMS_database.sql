...
create table users (
  ...
  profile_visibility_access boolean not null,
  profile_editing_access boolean not null,
  other_profile_editing_access boolean not null,
  primary key (username, password),
  foreign key (employee_id) references employee(employee_id) on delete cascade on update cascade,
  check ( profile_visibility_access  in (true,false)),
  check ( profile_editing_access  in (true,false)),
  check ( other_profile_editing_access  in (true,false))
);
